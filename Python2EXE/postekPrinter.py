...
class postekPrinter:
    ...
    def printDeviceLabel(self, _sn, _template):
        ...
        self.serialWrite("B530,70,4,1,2,4,56,N,\"SN:"+_sn+ "\"\r\n")    
        self.serialWrite("A270,135,0,2,1,1,N,\"SN:"+_sn+ "\"\r\n")
        self.serialWrite("A144,198,0,2,1,1,N,\""+_sn[len(_sn)-6:]+ "\"\r\n")
        self.serialWrite("W1\r\n")
    ...
    def printGiftBoxLabel(self, _sn, _template):
        ...
        self.serialWrite("A275,240,2,2,1,1,N,\"SN:"+_sn+ "\"\r\n")
        self.serialWrite("A425,63,2,1,1,1,N,\""+_sn[len(_sn)-6:]+ "\"\r\n")
        self.serialWrite("W1\r\n")
        self.serialWrite("GK\"SSGFX000\"\r\n")
    ...
    def printUserManualLabel(self, _sn, _sid, _template):
        ...
        self.serialWrite("A275,238,2,2,1,1,N,\"SN:"+_sn+ "\"\r\n")
        self.serialWrite("A368,210,2,2,1,1,N,\"SID:"+_sid+ "\"\r\n")
